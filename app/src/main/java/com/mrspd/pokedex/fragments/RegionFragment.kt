...
import com.mrspd.pokedex.adapters.RegionListAdapter
...
class RegionFragment : Fragment(R.layout.fragment_regions) {
    ...
    private var listAdapter = RegionListAdapter(arrayListOf())
    private var counter = 1

    private val regionObservers = androidx.lifecycle.Observer<RegionsResponse> {
        if (it != null) {
